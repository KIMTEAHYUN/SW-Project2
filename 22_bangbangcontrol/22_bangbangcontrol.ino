...
#define _DUTY_MAX 2066 // 2000
#define _DUTY_NEU 1500 // 1500
#define _DUTY_MIN 1068 // 1000

#define _SERVO_ANGLE_DIFF  183  // Replace with |D - E| degree
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(60, 0.5, 0));
...
float volt_to_distance(int a_value)
{
  ...
  return 526 + (-1.79*a_value) + 1.53E-03*a_value * a_value;
}
